...
public class AttackDataEditor : AttackLinkItemData, IEditorItem
{
    ...
    public void InitEditor()
    {
        ...
        {
            var buffEditorData = BuffUtilEditor.GetBuffDataEditor(item.Key);
    ...
    public Type GetScheduleEditorType(EnAtkLinkScheculeType scheduleType)
    {
        return scheduleType switch
        {
            ...
            EnAtkLinkScheculeType.Physics => typeof(AttackLinkPhysicsItemEditor),
    ...
    public void Draw()
    {
        ...
        {
            clipID = EditorGUILayout.IntField("剪辑类型", clipID, GUILayout.Width(300));
